...
class Video_Play_Pause
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Video_Play_Pause_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'video-play-pause';
	 ...
	 *
	 * - Video_Play_Pause_Loader. Orchestrates the hooks of the plugin.
	 * - Video_Play_Pause_i18n. Defines internationalization functionality.
	 * - Video_Play_Pause_Admin. Defines all hooks for the admin area.
	 * - Video_Play_Pause_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Video_Play_Pause_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
